    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 text-left  mb-1">
          <a href="https://express-zaim.web-design.kz/about" class="footer-menu-item">{{$t('links.about', { value: 'О компании'})}}</a>
          <a href="https://express-zaim.web-design.kz/news" class="footer-menu-item">{{$t('links.news', { value: 'Новости'})}}</a>
        </div>
